...
import cog from 'assets/images/settings-cog.png';
...
const data = [
  {
    ...
    icon: team,
    title: 'Meet the team',
    description: `We are a multidisciplinary team with several years of experience, and with solid partnerships among leading entities worldwide.`,
  },
  {
    id: 2,
    icon: cog,
